...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins yolo_conv_top_0/s_axi_AXILiteS]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins yolo_max_pool_top_0/s_axi_AXILiteS]
  connect_bd_intf_net -intf_net yolo_conv_top_0_outStream [get_bd_intf_pins yolo_conv_top_0/outStream] [get_bd_intf_pins yolo_max_pool_top_0/inStream]
  connect_bd_intf_net -intf_net yolo_max_pool_top_0_outStream [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins yolo_max_pool_top_0/outStream]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins yolo_conv_top_0/ap_rst_n] [get_bd_pins yolo_max_pool_top_0/ap_rst_n]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs yolo_conv_top_0/s_axi_AXILiteS/Reg] SEG_yolo_conv_top_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs yolo_max_pool_top_0/s_axi_AXILiteS/Reg] SEG_yolo_max_pool_top_0_Reg
