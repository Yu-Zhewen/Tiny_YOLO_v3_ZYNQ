...
entity window_macc_kernel_weight_4_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 27
...
architecture rtl of window_macc_kernel_weight_4_rom is 
...
signal mem0 : mem_array := (
    0 => "11000000111000110000110010110101", 
    1 => "11000001001100100010101100110010", 
    2 => "11000000110111101101101000001100", 
    3 => "01000000000011101011000000010000", 
    4 => "10111101000100110010100000110001", 
    5 => "00111111001100100011110110010010", 
    6 => "01000000110110010101101111000100", 
    7 => "01000001000100011010100101100000", 
    8 => "01000000101011110001110101100111", 
    9 => "11000000111101111100000101010111", 
    10 => "11000001001100000101010010101110", 
    11 => "11000000101101000110010101110001", 
    12 => "00111111100000110011110110000110", 
    13 => "01000000001010100011100111000101", 
    14 => "00111111001111010000001101000011", 
    15 => "01000000101101000110111111001000", 
    16 => "01000001000111011100011000101100", 
    17 => "01000000100010100101100001110101", 
    18 => "11000000100001010011110111011110", 
    19 => "11000001000000001011011101110000", 
    20 => "11000000010101111001100010011010", 
    21 => "00111111110111000001101100101010", 
    22 => "00111111110100111110111110101110", 
    23 => "00111111001111011101010111110101", 
    24 => "01000000010010011110001000000000", 
    25 => "01000000101011110011110000100001", 
    26 => "01000000010001101111010000111000" );
...
entity window_macc_kernel_weight_4 is
    generic (
...
architecture arch of window_macc_kernel_weight_4 is
    component window_macc_kernel_weight_4_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    window_macc_kernel_weight_4_rom_U :  component window_macc_kernel_weight_4_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
