...
entity window_macc_kernel_weight_8_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 27
...
architecture rtl of window_macc_kernel_weight_8_rom is 
...
signal mem0 : mem_array := (
    0 => "11000000110110101010000000010000", 
    1 => "00111111110000100010111111100000", 
    2 => "01000001001000011001011101001010", 
    3 => "11000000110001000100011110000010", 
    4 => "11000001010011111011101010110100", 
    5 => "01000001100000011000010010001100", 
    6 => "01000000011000010000110000110001", 
    7 => "11000001010100100110001001010111", 
    8 => "01000000111100111001110010001000", 
    9 => "10111111100111110011011010111101", 
    10 => "10111111100111111010010000001110", 
    11 => "01000000101101000000001111010101", 
    12 => "01000000000111001111000111100101", 
    13 => "11000001011101110000110001111011", 
    14 => "01000001000011100100101000010011", 
    15 => "01000001001110101010101100011010", 
    16 => "11000001001001111001000110010100", 
    17 => "10111110011000111111011101001001", 
    18 => "01000000000000010101001111000101", 
    19 => "10111110111111010011100101110101", 
    20 => "10111111111010011100111100101101", 
    21 => "01000000101010010010010000011110", 
    22 => "11000000110110001011100010000010", 
    23 => "10111111101011101000101101001100", 
    24 => "01000001000111001000001011001011", 
    25 => "11000000000000011000001100111100", 
    26 => "11000000100111000001101111000001" );
...
entity window_macc_kernel_weight_8 is
    generic (
...
architecture arch of window_macc_kernel_weight_8 is
    component window_macc_kernel_weight_8_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    window_macc_kernel_weight_8_rom_U :  component window_macc_kernel_weight_8_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
