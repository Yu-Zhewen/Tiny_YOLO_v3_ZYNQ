...
entity window_macc_kernel_weight_0_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 27
...
architecture rtl of window_macc_kernel_weight_0_rom is 
...
signal mem0 : mem_array := (
    0 => "00111111110000111010101001110001", 
    1 => "01000000010101110011000100101111", 
    2 => "00111111111010001000011011001111", 
    3 => "01000000100000001110010010011111", 
    4 => "10111111111010011100000110000011", 
    5 => "11000000011011000111001110000010", 
    6 => "10111101111110011101001000111001", 
    7 => "11000000110110000000011110001001", 
    8 => "10111111011110011010101110001111", 
    9 => "00111111110000111010100101011101", 
    10 => "01000000001000100110100010101101", 
    11 => "00111011111011100010000000000100", 
    12 => "01000000000011110111011001001111", 
    13 => "11000000001101110110001011001100", 
    14 => "11000000100011010000001110011001", 
    15 => "00111110110110010000011110111000", 
    16 => "11000000100101011110010011000111", 
    17 => "00111110001100111000010010111010", 
    18 => "11000000000101101101101011001111", 
    19 => "10111011100001101011110111110101", 
    20 => "10111111100000100001001110110010", 
    21 => "00111000010011011000010101011001", 
    22 => "10111011111111100010111001101111", 
    23 => "10111111010110110011110101011100", 
    24 => "10111110001101011011000111001000", 
    25 => "10111111110010001101100110011101", 
    26 => "00111111000001110000001001001111" );
...
entity window_macc_kernel_weight_0 is
    generic (
...
architecture arch of window_macc_kernel_weight_0 is
    component window_macc_kernel_weight_0_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    window_macc_kernel_weight_0_rom_U :  component window_macc_kernel_weight_0_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
