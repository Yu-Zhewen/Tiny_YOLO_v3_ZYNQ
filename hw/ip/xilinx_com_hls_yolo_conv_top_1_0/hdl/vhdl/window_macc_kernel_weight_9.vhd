...
entity window_macc_kernel_weight_9_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 27
...
architecture rtl of window_macc_kernel_weight_9_rom is 
...
signal mem0 : mem_array := (
    0 => "11000000110011000101101111101110", 
    1 => "10111111111000110111101110100110", 
    2 => "01000000110001010101111100101001", 
    3 => "11000001000100110100000011011101", 
    4 => "10111110111000101001011001001111", 
    5 => "01000001000110101100011011100111", 
    6 => "11000000110100101111001001110011", 
    7 => "01000000001010100011000111111101", 
    8 => "01000000110010011000001010101100", 
    9 => "11000000101011110001011010001001", 
    10 => "10111111100010100010101011010100", 
    11 => "01000000101001011010010011010001", 
    12 => "11000001000010100110001111001110", 
    13 => "10111110101101011000011101010001", 
    14 => "01000001000010111101011111010000", 
    15 => "11000000101100001100011100000010", 
    16 => "01000000001010110001011000110011", 
    17 => "01000000100000110100010111000101", 
    18 => "11000000010101010100000110001001", 
    19 => "00111110010010001110000110010011", 
    20 => "01000000001110101111000010000000", 
    21 => "11000000101101101110101111010111", 
    22 => "00111111000110010001110111011110", 
    23 => "01000000101000011011101001100010", 
    24 => "11000000100100010000101110010011", 
    25 => "01000000001011100010001100111010", 
    26 => "01000000000110111000101111011011" );
...
entity window_macc_kernel_weight_9 is
    generic (
...
architecture arch of window_macc_kernel_weight_9 is
    component window_macc_kernel_weight_9_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    window_macc_kernel_weight_9_rom_U :  component window_macc_kernel_weight_9_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
