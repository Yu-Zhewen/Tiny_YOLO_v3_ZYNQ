...
add_files -tb yolo_max_pool_2019/tb/layer_input.dat -cflags "-Wno-unknown-pragmas"
add_files -tb yolo_max_pool_2019/tb/layer_output_sdk.dat -cflags "-Wno-unknown-pragmas"
add_files -tb yolo_max_pool_2019/tb/yolo_max_pool_tb.cpp -cflags "-Wno-unknown-pragmas"
