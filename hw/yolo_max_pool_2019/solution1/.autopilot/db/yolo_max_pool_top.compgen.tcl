...
set id 15
set name yolo_max_pool_top_fcmp_32ns_32ns_1_2_1
...
set id 17
set name yolo_max_pool_top_mux_164_32_1_1
...
set ID 23
set hasByteEnable 0
set MemName yolo_max_pool_top_line_buff_group_val_s
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 24 \
			corename yolo_max_pool_top_AXILiteS_axilite \
			name yolo_max_pool_top_AXILiteS_s_axi \
			ports {$port_AXILiteS} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler yolo_max_pool_top_AXILiteS_s_axi
}
