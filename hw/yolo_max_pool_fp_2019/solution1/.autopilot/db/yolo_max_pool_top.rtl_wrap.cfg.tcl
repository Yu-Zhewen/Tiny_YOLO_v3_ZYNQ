...
set DataType0 [list "ap_axif<32, 2, 5, 6>" "struct ap_axif" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType1 [list "ap_axif<32, 2, 5, 6>" "struct ap_axif" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
