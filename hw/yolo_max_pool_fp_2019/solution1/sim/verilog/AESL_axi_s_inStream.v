...
module AESL_axi_s_inStream (
    ...
    fifo #(1384448, 32) fifo_inStream_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1384448, 4) fifo_inStream_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1384448, 4) fifo_inStream_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1384448, 2) fifo_inStream_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1384448, 1) fifo_inStream_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1384448, 5) fifo_inStream_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1384448, 6) fifo_inStream_TDEST (
        .reset(1'b0),
        .write_clock(clk),
