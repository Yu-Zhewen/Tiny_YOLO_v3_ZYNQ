...
module AESL_axi_s_outStream (
    ...
    fifo #(33280, 32) fifo_outStream_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(33280, 4) fifo_outStream_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(33280, 4) fifo_outStream_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(33280, 2) fifo_outStream_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(33280, 1) fifo_outStream_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(33280, 5) fifo_outStream_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(33280, 6) fifo_outStream_TDEST (
        .reset(1'b0),
        .write_clock(clk),
