		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			if (i > 0)
			{
				// RTL Name: outStream_V_data
				{
					// bitslice(31, 0)
					// {
						// celement: outStream.V.data(31, 0)
						// {
							sc_lv<32>* outStream_V_data_lv0_0_0_1_lv1_0_0_1 = new sc_lv<32>[aesl_tmp_4 - aesl_tmp_5];
						// }
					// }
						...
						// celement: outStream.V.data(31, 0)
						{
							...
							for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									{
										outStream_V_data_lv0_0_0_1_lv1_0_0_1[hls_map_index].range(31, 0) = sc_bv<32>(outStream_V_data_pc_buffer[hls_map_index].range(31, 0));
										hls_map_index++;
									}
								}
							}
						...
						// celement: outStream.V.data(31, 0)
						{
							...
							for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									// output_type_conversion : (outStream_V_data_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_uint64()
									if (&(aesl_tmp_3[0].data) != NULL) // check the null address if the c port is array or others
									{
										*(int*)&aesl_tmp_3[i_0].data = (outStream_V_data_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_uint64();
										hls_map_index++;
									}
								}
							}
				...
				// celement: inStream.V.data(31, 0)
				{
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_1 - aesl_tmp_2 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							// regulate_c_name       : inStream_V_data
							...
							{
								sc_lv<32> inStream_V_data_tmp_mem;
								inStream_V_data_tmp_mem = *(int*)&aesl_tmp_0[i_0].data;
								inStream_V_data_tvin_wrapc_buffer[hls_map_index].range(31, 0) = inStream_V_data_tmp_mem.range(31, 0);
                                 		       hls_map_index++;
							}
						}
					}
				...
				// celement: outStream.V.data(31, 0)
				{
					...
					for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							// sub_1st_elem          : 0 0
							// ori_name_1st_elem     : aesl_tmp_3[0].data
							// regulate_c_name       : outStream_V_data
							// input_type_conversion : *(int*)&aesl_tmp_3[i_0].data
							if (&(aesl_tmp_3[0].data) != NULL) // check the null address if the c port is array or others
							{
								sc_lv<32> outStream_V_data_tmp_mem;
								outStream_V_data_tmp_mem = *(int*)&aesl_tmp_3[i_0].data;
								outStream_V_data_tvout_wrapc_buffer[hls_map_index].range(31, 0) = outStream_V_data_tmp_mem.range(31, 0);
                                 		       hls_map_index++;
							}
						}
					}
