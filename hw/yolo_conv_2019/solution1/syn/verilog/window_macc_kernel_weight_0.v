...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module window_macc_kernel_weight_0_rom (
...
initial begin
    $readmemh("./window_macc_kernel_weight_0_rom.dat", ram0);
    $readmemh("./window_macc_kernel_weight_0_rom.dat", ram1);
    $readmemh("./window_macc_kernel_weight_0_rom.dat", ram2);
    $readmemh("./window_macc_kernel_weight_0_rom.dat", ram3);
    $readmemh("./window_macc_kernel_weight_0_rom.dat", ram4);
end
...
`timescale 1 ns / 1 ps
module window_macc_kernel_weight_0(
    reset,
    clk,
    address0,
    ce0,
...
window_macc_kernel_weight_0_rom window_macc_kernel_weight_0_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
