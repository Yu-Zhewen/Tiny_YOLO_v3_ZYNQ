...
set id 68
set name yolo_conv_top_mul_mul_6ns_16s_22_1_1
...
set ID 86
set hasByteEnable 0
set MemName yolo_conv_top_line_buff_group_1_va
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 16
set AddrRange 418
...
set ID 87
set hasByteEnable 0
set MemName yolo_conv_top_local_mem_group_data
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 16
set AddrRange 48
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 104 \
			corename yolo_conv_top_AXILiteS_axilite \
			name yolo_conv_top_AXILiteS_s_axi \
			ports {$port_AXILiteS} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler yolo_conv_top_AXILiteS_s_axi
}
