...
void parse_net_options(network *net)
{
    ...
    int *steps = (int *)calloc(2, sizeof(int));
    float *scales = (float *)calloc(2, sizeof(float));
    steps[0] = 400000;
    steps[1] = 450000;
    scales[0] = 0.1f;
    scales[1] = 0.1f;
...
layer parse_yolo(int classes, int total, int num, int *mask, int batch, int w, int h, int max, float jitter, float ignore_thresh, float truth_thresh, int random, short *anchors, size_params params)
{
...
//    }
    memcpy(l.biases,anchors,2*total*sizeof(short));
    return l;
}
...
void parse_layer_17(int *count_p,size_params *params_p,network *net,size_t *workspace_size_p)
{
    ...
    int *layers = (int *)calloc(1, sizeof(int));
...
void parse_layer_20(int *count_p,size_params *params_p,network *net,size_t *workspace_size_p)
{
	...
	int batch = params_p->batch;
	int n = 2;
    int *layers = (int *)calloc(2, sizeof(int));
    int *sizes = (int *)calloc(2, sizeof(int));
...
network *parse_network_cfg()
{
    ...
    net->input = (fp_data_type *)calloc(net->inputs*net->batch, sizeof(fp_data_type));
    net->truth = (float *)calloc(net->truths*net->batch, sizeof(float));

    if(workspace_size)
    {
    	net->workspace = (fp_data_type *)calloc(1, workspace_size);
    }
...
void load_weights(network *net)
{
    ...
    conv_weight_file[0].biases           = (fp_weight_type *)conv_0_biases_bn_fp;
...
//    conv_weight_file[0].rolling_variance = conv_0_rolling_variance;
    conv_weight_file[0].weights          = (fp_weight_type *)conv_0_weights_bn_fp;

    conv_weight_file[1].biases           = (fp_weight_type *)conv_1_biases_bn_fp;
...
//    conv_weight_file[1].rolling_variance = conv_1_rolling_variance;
    conv_weight_file[1].weights          = (fp_weight_type *)conv_1_weights_bn_fp;

    conv_weight_file[2].biases           = (fp_weight_type *)conv_2_biases_bn_fp;
...
//    conv_weight_file[2].rolling_variance = conv_2_rolling_variance;
    conv_weight_file[2].weights          = (fp_weight_type *)conv_2_weights_bn_fp;

    conv_weight_file[3].biases           = (fp_weight_type *)conv_3_biases_bn_fp;
...
//    conv_weight_file[3].rolling_variance = conv_3_rolling_variance;
    conv_weight_file[3].weights          = (fp_weight_type *)conv_3_weights_bn_fp;

    conv_weight_file[4].biases           = (fp_weight_type *)conv_4_biases_bn_fp;
...
//    conv_weight_file[4].rolling_variance = conv_4_rolling_variance;
    conv_weight_file[4].weights          = (fp_weight_type *)conv_4_weights_bn_fp;

    conv_weight_file[5].biases           = (fp_weight_type *)conv_5_biases_bn_fp;
...
//    conv_weight_file[5].rolling_variance = conv_5_rolling_variance;
    conv_weight_file[5].weights          = (fp_weight_type *)conv_5_weights_bn_fp;

    conv_weight_file[6].biases           = (fp_weight_type *)conv_6_biases_bn_fp;
...
//    conv_weight_file[6].rolling_variance = conv_6_rolling_variance;
    conv_weight_file[6].weights          = (fp_weight_type *)conv_6_weights_bn_fp;

    conv_weight_file[7].biases           = (fp_weight_type *)conv_7_biases_bn_fp;
...
//    conv_weight_file[7].rolling_variance = conv_7_rolling_variance;
    conv_weight_file[7].weights          = (fp_weight_type *)conv_7_weights_bn_fp;

    conv_weight_file[8].biases           = (fp_weight_type *)conv_8_biases_bn_fp;
...
//    conv_weight_file[8].rolling_variance = conv_8_rolling_variance;
    conv_weight_file[8].weights          = (fp_weight_type *)conv_8_weights_bn_fp;

    conv_weight_file[9].biases           = (fp_weight_type *)conv_9_biases_bn_fp;
    conv_weight_file[9].weights          = (fp_weight_type *)conv_9_weights_bn_fp;

    conv_weight_file[10].biases           = (fp_weight_type *)conv_10_biases_bn_fp;
...
//    conv_weight_file[10].rolling_variance = conv_10_rolling_variance;
    conv_weight_file[10].weights          = (fp_weight_type *)conv_10_weights_bn_fp;

    conv_weight_file[11].biases           = (fp_weight_type *)conv_11_biases_bn_fp;
...
//    conv_weight_file[11].rolling_variance = conv_11_rolling_variance;
    conv_weight_file[11].weights          = (fp_weight_type *)conv_11_weights_bn_fp;

    conv_weight_file[12].biases           = (fp_weight_type *)conv_12_biases_bn_fp;
    conv_weight_file[12].weights          = (fp_weight_type *)conv_12_weights_bn_fp;
