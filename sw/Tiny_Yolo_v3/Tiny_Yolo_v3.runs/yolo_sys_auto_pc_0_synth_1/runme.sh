...
HD_PWD='/home/xavier/MSc_Project/git_v/Tiny_YOLO_v3_ZYNQ/sw/Tiny_Yolo_v3/Tiny_Yolo_v3.runs/yolo_sys_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log yolo_sys_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source yolo_sys_auto_pc_0.tcl
