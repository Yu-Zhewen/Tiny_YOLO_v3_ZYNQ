...
set rc [catch {
  ...
  set_param project.isImplRun false
  write_hwdef -force -file yolo_sys_wrapper.hwdef
...
set rc [catch {
  ...
  opt_design 
  write_checkpoint -force yolo_sys_wrapper_opt.dcp
  create_report "impl_1_opt_report_drc_0" "report_drc -file yolo_sys_wrapper_drc_opted.rpt -pb yolo_sys_wrapper_drc_opted.pb -rpx yolo_sys_wrapper_drc_opted.rpx"
...
set rc [catch {
  ...
  create_report "impl_1_place_report_utilization_0" "report_utilization -file yolo_sys_wrapper_utilization_placed.rpt -pb yolo_sys_wrapper_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file yolo_sys_wrapper_control_sets_placed.rpt"
...
set rc [catch {
  ...
  route_design 
  write_checkpoint -force yolo_sys_wrapper_routed.dcp
  create_report "impl_1_route_report_drc_0" "report_drc -file yolo_sys_wrapper_drc_routed.rpt -pb yolo_sys_wrapper_drc_routed.pb -rpx yolo_sys_wrapper_drc_routed.rpx"
...
if {$rc} {
  write_checkpoint -force yolo_sys_wrapper_routed_error.dcp
...
set rc [catch {
  ...
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
  catch { write_mem_info -force yolo_sys_wrapper.mmi }
  write_bitstream -force yolo_sys_wrapper.bit 
  catch { write_sysdef -hwdef yolo_sys_wrapper.hwdef -bitfile yolo_sys_wrapper.bit -meminfo yolo_sys_wrapper.mmi -file yolo_sys_wrapper.sysdef }
  catch {write_debug_probes -quiet -force yolo_sys_wrapper}
  catch {file copy -force yolo_sys_wrapper.ltx debug_nets.ltx}
