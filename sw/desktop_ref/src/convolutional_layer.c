...
{
//	FILE *fp;
//	char file_name[64]="conv_";
//	char num[8];
//	sprintf(num,"%d",conv_count);
//	strcat(file_name,num);
//	strcat(file_name,"_param.h");
//	fp = fopen(file_name,"w");
//
//	fprintf(fp,"#ifndef CONV_%d_PARAM_H\n",conv_count);
//	fprintf(fp,"#define CONV_%d_PARAM_H\n\n",conv_count);
//
//	fprintf(fp,"#define CONV_%d_KERNEL_DIM %d\n",conv_count,l.size);
//	fprintf(fp,"#define CONV_%d_PAD %d\n",conv_count,l.pad);
//	fprintf(fp,"#define CONV_%d_INPUT_CAHNNEL %d\n",conv_count,l.c);
//	fprintf(fp,"#define CONV_%d_INPUT_WIDTH (%d+2*PAD)\n",conv_count,l.w);
//	fprintf(fp,"#define CONV_%d_INPUT_HEIGHT (%d+2*PAD)\n",conv_count,l.h);
//	fprintf(fp,"#define CONV_%d_OUTPUT_CHANNEL %d\n",conv_count,l.n);
//	fprintf(fp,"#define CONV_%d_OUTPUT_WIDTH %d\n",conv_count,l.out_w);
//	fprintf(fp,"#define CONV_%d_OUTPUT_HEIGHT %d\n\n",conv_count,l.out_h);
//
//	fprintf(fp,"conv_param conv_%d_param={.kernel_dim=%d,\n",conv_count,l.size);
//	fprintf(fp,"                          .pad=%d,\n",l.pad);
//	fprintf(fp,"                          .input_channel=%d,\n",l.c);
//	fprintf(fp,"                          .input_width=%d,\n",l.w+2*l.pad);
//	fprintf(fp,"                          .input_height=%d,\n",l.h+2*l.pad);
//	fprintf(fp,"                          .output_channel=%d,\n",l.n);
//	fprintf(fp,"                          .output_width=%d,\n",l.out_w);
//	fprintf(fp,"                          .output_height=%d};\n\n",l.out_h);
//
//	fprintf(fp,"#endif\n");
//	fclose(fp);
//	conv_count++;
